...
# slide: Number of Sightings Over the Years {data-background="ETfinger.jpg"}
```{r}
years_ufo <- new_ufo %>% 
...
ggplot(years_ufo, aes(x = year, y = n)) +
  ...
  scale_x_continuous(
    limits = c(min(years_ufo$year), 2013),
    breaks = seq(min(years_ufo$year), max(years_ufo$year), by = 5)) +
